...
const Home = () => {
  return (
    <section className="Home min-h-screen w-full pt-32 pb-4">
      <div className="lg:max-w-7xl lg:mx-auto text-center md:pt-60 lg:pt-32 lg:flex lg:items-center lg:justify-around lg:text-left">
        <div>
