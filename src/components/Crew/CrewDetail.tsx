...
const CrewDetail = () => {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-col-reverse lg:flex-row-reverse lg:w-[70rem] lg:mx-auto  lg:items-start lg:mt-[-6rem]">
        ...
        <div className="lg:flex lg:flex-col-reverse lg:justify-start lg:mt-48">
